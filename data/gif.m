function plotPos3D_animated()
    % 加载轨迹数据
    pos_km = loadjson('./run_data/pos_km_tree1.json');
    ...
    % 实时机器人位置（动态）
    h_robots = scatter3(NaN(numAgents,1), NaN(numAgents,1), NaN(numAgents,1), ...
                        currentMarkerSize, currentMarkerColor, 'filled');
